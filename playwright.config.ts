  ...
  projects: [
    {
      name: "mobile-320",
      grepInvert:
        /@authenticated|@calendar|@profile|@photo-layout|@camera-capability|@voice|@video|@place|@search|@tags|@ai|@report|@chat/,
